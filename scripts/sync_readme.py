"""README auto-update for root apps & modules downloads index."""
...
def generate_apps_table(
    ...
    """Generate the markdown table for all synced root apps & modules."""
    ...
    if not has_entries:
        lines.append("| _No packages synced yet._ | — | — | — | — | — |")
...
def update_readme(
    ...
    """Update the README.md with the auto-generated downloads table."""
    ...
    logger.info("README.md updated with latest downloads table.")
    return True
